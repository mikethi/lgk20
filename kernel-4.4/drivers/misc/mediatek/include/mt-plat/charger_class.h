...
#ifdef CONFIG_LGE_PM
	int (*input_suspend)(struct charger_device *dev, bool en);
	int (*is_input_suspended)(struct charger_device *dev, bool *en);
...
#ifdef CONFIG_LGE_PM
extern int charger_dev_input_suspend(struct charger_device *charger_dev, bool en);
extern int charger_dev_is_input_suspended(struct charger_device *charger_dev, bool *en);
...
extern int charger_dev_is_ship_mode_enabled(struct charger_device *charger_dev, bool *en);
#endif
