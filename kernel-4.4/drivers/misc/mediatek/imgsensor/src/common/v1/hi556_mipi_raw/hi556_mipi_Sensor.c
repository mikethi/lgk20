...
int otp_grp1_flag = 0, otp_grp2_flag = 0, otp_grp3_flag = 0, minfo_start_addr = 0;
...
otp_grp1_flag = read_cmos_sensor(0x0108);
LOG_INF("otp_grp1_flag = 0x%x\n",otp_grp1_flag);
/* read grp 2 flag */
write_cmos_sensor_8(0x010a,((0x040a)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x040a)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp2_flag = read_cmos_sensor(0x0108);
LOG_INF("otp_grp2_flag = 0x%x\n",otp_grp2_flag);
/* read grp 3 flag */
write_cmos_sensor_8(0x010a,((0x0413)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x0413)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp3_flag = read_cmos_sensor(0x0108);
LOG_INF("otp_grp3_flag = 0x%x\n",otp_grp3_flag);
if(otp_grp1_flag == 0x55)
	minfo_start_addr = 0x0402;
else if (otp_grp2_flag == 0x55)
	minfo_start_addr = 0x040b;
else if(otp_grp3_flag == 0x55)
	minfo_start_addr = 0x0414;
else{
...
if(minfo_start_addr != 0){
  ...
  write_cmos_sensor_8(0x0102,0x01);
	...
	check_sum_cal += 0x55;/*check sum include group flag*/
...
int otp_grp1_flag = 0, otp_grp2_flag = 0, otp_grp3_flag = 0, awb_start_addr=0;
int check_sum_awb = 0, check_sum_awb_cal = 0;
int r ,b ,gr, gb, golden_r, golden_b, golden_gr, golden_gb;
int i;
/* awb group 1 */
write_cmos_sensor_8(0x010a,((0x041c)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x041c)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp1_flag = read_cmos_sensor(0x0108);
LOG_INF("awb_otp_grp1_flag = 0x%x\n",otp_grp1_flag);
/* awb group 2 */
write_cmos_sensor_8(0x010a,((0x042e)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x042e)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp2_flag = read_cmos_sensor(0x0108);
LOG_INF("awb_otp_grp2_flag = 0x%x\n",otp_grp2_flag);
/* awb group 3 */
write_cmos_sensor_8(0x010a,((0x0440)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x0440)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp3_flag = read_cmos_sensor(0x0108);
LOG_INF("awb_otp_grp3_flag = 0x%x\n",otp_grp3_flag);

if(otp_grp1_flag == 0x55)
	awb_start_addr = 0x041d;
else if (otp_grp2_flag == 0x55)
	awb_start_addr = 0x042f;
else if(otp_grp3_flag == 0x55)
	awb_start_addr = 0x0441;
else{
...
if(awb_start_addr != 0)
{
  ...
  write_cmos_sensor_8(0x0102,0x01);
	...
	check_sum_awb_cal += 0x55;/*check sum include group flag*/
  ...
  //LOG_INF("r=0x%x, b=0x%x, gr=%x, gb=0x%x\n", r, b,gb, gr);
...
int otp_grp1_flag = 0, otp_grp2_flag = 0, otp_grp3_flag = 0, lsc_start_addr = 0;
int check_sum_lsc = 0, check_sum_lsc_cal = 0;
int i;
/* lsc group 1 */
write_cmos_sensor_8(0x010a,((0x0452)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x0452)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp1_flag = read_cmos_sensor(0x0108);
LOG_INF("lsc_otp_grp1_flag = 0x%x\n",otp_grp1_flag);
/* lsc group 2 */
write_cmos_sensor_8(0x010a,((0x0ba0)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x0ba0)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp2_flag = read_cmos_sensor(0x0108);
LOG_INF("lsc_otp_grp2_flag = 0x%x\n",otp_grp2_flag);
/* lsc group 3 */
write_cmos_sensor_8(0x010a,((0x12ee)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x12ee)&0xff);
write_cmos_sensor_8(0x0102,0x01);
otp_grp3_flag = read_cmos_sensor(0x0108);
LOG_INF("lsc_otp_grp3_flag = 0x%x\n",otp_grp3_flag);

if(otp_grp1_flag == 0x55)
	lsc_start_addr = 0x0453;
else if (otp_grp2_flag == 0x55)
	lsc_start_addr = 0x0ba1;
else if(otp_grp3_flag == 0x55)
	lsc_start_addr = 0x12ef;
else{
	LOG_INF("no AWB OTP data return \n");
	return 0;
}
...
if(lsc_start_addr != 0){
  ...
  write_cmos_sensor_8(0x0102,0x01);
	...
	for(i = 0; i < LSC_DATA_SIZE; i++){
		//pr_err("=== HI556 LSC[%d]: %x ===\n", i, hi556_data_lsc[i]);
	  check_sum_lsc_cal += hi556_data_lsc[i];
	}	
	check_sum_lsc_cal += 0x55;/*check sum include group flag*/
...
for(i=0;i<=7;i++)
{
write_cmos_sensor_8(0x010a,((0x0078+i)>>8)&0xff);
write_cmos_sensor_8(0x010b,(0x0078+i)&0xff);
write_cmos_sensor_8(0x0102,0x02);
write_cmos_sensor_8(0x0106,data_gain[i]);
mdelay(4);
temp_gain[i]=read_cmos_sensor(0x010d);
LOG_INF("temp_gain[%d]=0x%x\n",i,temp_gain[i]);
}
write_cmos_sensor_8(0x0a00,0x00);
mdelay(10);
write_cmos_sensor_8(0x003e,0x00);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
				*sensor_id =return_sensor_id();
				...
				//sprintf(Front_Camera_Name,"HI556:E_welly:5001"); 
#ifdef HI556_OTP
  			sensor_init();
			  rc = read_hi556_otp();
				if(rc == 0){
					*sensor_id = 0xFFFFFFFF;
					pr_err("Hi556 read OTP:NOK");
