...
#define PE20_VOLTAGE_MIN (55000000)	/* 5.5V */
#define PE20_VOLTAGE_MAX (200000000)	/* 20V */
#define PE20_VOLTAGE_STEP (5000000)	/* 0.5V */
...
static int pe20_send_bit(struct charger_device *chg_dev, int bit, int data)
{
	...
	if (pd_high.actual < pd_high.target_min
			|| pd_high.actual > pd_high.target_min) {
	...
	if (pd_low.actual < pd_low.target_min
			|| pd_low.actual > pd_low.target_min) {
