...
static int param_set_pseudo_hvdcp(const char *val, const struct kernel_param *kp)
{
...
static int param_get_pseudo_hvdcp(char *buffer, const struct kernel_param *kp)
{
...
static int param_set_pseudo_hvdcp_mode(const char *val, struct kernel_param *kp)
{
	int ret;
