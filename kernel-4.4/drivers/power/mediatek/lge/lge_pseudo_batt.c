...
static int param_get_pseudo_batt(char *buffer, const struct kernel_param *kp)
{
...
static int param_set_pseudo_batt_mode(const char *val, struct kernel_param *kp)
{
...
module_param_named(battery_capacity, pseudo_batt.capacity, int,
		PSEUDO_BATT_RW_PERM);
module_param_named(battery_charging, pseudo_batt.charging, int,
		PSEUDO_BATT_RW_PERM);
