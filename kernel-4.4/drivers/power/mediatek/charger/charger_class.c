...
#ifdef CONFIG_LGE_PM
int charger_dev_input_suspend(struct charger_device *charger_dev, bool en)
{
	if (charger_dev != NULL && charger_dev->ops != NULL && charger_dev->ops->input_suspend)
		return charger_dev->ops->input_suspend(charger_dev, en);

	return -ENOTSUPP;
}
EXPORT_SYMBOL(charger_dev_input_suspend);

int charger_dev_is_input_suspended(struct charger_device *charger_dev, bool *en)
{
	if (charger_dev != NULL && charger_dev->ops != NULL && charger_dev->ops->is_input_suspended)
		return charger_dev->ops->is_input_suspended(charger_dev, en);

	return -ENOTSUPP;
}
EXPORT_SYMBOL(charger_dev_is_input_suspended);
...
int charger_dev_is_ship_mode_enabled(struct charger_device *charger_dev, bool *en)
{
	if (charger_dev != NULL && charger_dev->ops != NULL && charger_dev->ops->is_ship_mode_enabled)
		return charger_dev->ops->is_ship_mode_enabled(charger_dev, en);
